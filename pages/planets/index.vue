<template>
 <NuxtLayout name="base">
    <h1 class="mb-5"> Planets List</h1>
    <div class="row">
      <div v-for="(item, key) in planets" :key="key" class="col-lg-4 col-sm-6 col-12 d-flex align-items-stretch">
...
<script setup>
  const { data: planets } = await useFetch(
